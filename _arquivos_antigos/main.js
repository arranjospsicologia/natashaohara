...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // ========== CONSOLE MESSAGE ==========
    console.log('%c🌟 Natasha O\'hara - Especialista em Cabelos Naturais 🌟', 'font-size: 16px; color: #3e6634; font-weight: bold;');
    console.log('%c📱 Agende seu horário: (27) 99927-1812', 'font-size: 14px; color: #f79b00;');
    console.log('%c📸 Instagram: @nattasha.ohara', 'font-size: 14px; color: #f79b00;');
});
